 ...
 * interested in processing a replication event implements this interface, and
 * the object created with that class is registered with an instance of
 * {@link Replicating}, using the replicating's registerReplicatingListener
 * method. When the event occurs, the object's {@link #onReplicated} method is
 * invoked.
 */
